...
Field Name | Type | Description
---|:---:|---
<a name="name"></a>type | `name` | **Required.** Name of the type. e.g. int, uint8e, Price, Boolean, etc.
<a name="baseType"></a>baseType | `string` | **Required.** Specifies the base type of the value. Value MUST be fron the list: `"boolean"`, `"integer"`, `"number"`, `"string"`,
...
Field Name | Type | Description
---|:---:|---
<a name="valueEnum"></a>enum | `string` or `integer`| **Required.** Enumeration as it appears on the wire.
